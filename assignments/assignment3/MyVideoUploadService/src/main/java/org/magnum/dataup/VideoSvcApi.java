...
public interface VideoSvcApi {
	...
	public static final String VIDEO_RATING_PATH = VIDEO_SVC_PATH + "/{id}/rating/{rating}";
	...
	/**
	 * This endpoint allows clients to UPDATE Video objects RATING by sending POST requests
	 * that have an application/json body containing the Video object information. 
	 * 
	 * @return
	 */
	@GET(VIDEO_RATING_PATH)
	public int updateVideoRating(@Path(ID_PARAMETER) long id, @Path(RATING_PARAMETER) int rating);
}
