...
public class VideoDataMediator {
                ...
                try {
                    ...
                    if (receivedVideo != null) {
                        ...
                        if (status.getState() == VideoState.READY) {
                            ...
                            addVideoToCache(context, receivedVideo);
    ...
    public List<Video> getVideoList() {
        try {
            ArrayList<Video> videoList = (ArrayList<Video>) mVideoServiceProxy.getVideoList();
            return (videoList);
        } catch (Exception e) {
           return null; 
        }
    ...
    private void addVideoToCache(Context context, Video video){
        ContentProviderVideoCache videoCacheProvider = new ContentProviderVideoCache(context);
        videoCacheProvider.put(video);
    }
}
