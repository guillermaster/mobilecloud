...
public class VideoOps
    ...
    public void onConfiguration(VideoOps.View view,
        ...
        // check if the activity is the one that displays the video list
        if(ActivityDisplaysVideoList()){
            DisplayVideoList(firstTimeIn);
        }else{
            // is not the activity that displays the video list
            // it is guessed that it is the single video info activity
    ...
    private boolean ActivityDisplaysVideoList(){
        return true; //TODO: IMPLEMENT THIS METHOD
    }

    private void DisplayVideoList(boolean firstTimeIn){
        if (firstTimeIn) {
