...
import vandy.mooc.provider.ContentProviderVideoCache;
import vandy.mooc.utils.Constants;
import vandy.mooc.view.UploadedVideoActivity;
...
public class VideoAdapter
    ...
    public View getView(int position,
        ...
        titleText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent uploadedVideoActIntent = new Intent(mContext, UploadedVideoActivity.class);
                uploadedVideoActIntent.putExtra(Constants.EXTRA_VIDEO_ID, video.getId());
                uploadedVideoActIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                mContext.startActivity(uploadedVideoActIntent);
            }
        });
    ...
    public void setVideos(List<Video> videos) {
        ...
        addVideosToCache(videos);//TODO: ADD ASYNC SUPPORT
        notifyDataSetChanged();
    }

    private void addVideosToCache(List<Video> videos){
        ContentProviderVideoCache videoCacheProvider = new ContentProviderVideoCache(mContext);
        videoCacheProvider.put(videos);
    }
